...
public class RNGSearchDriver extends Configured implements Tool{

	public static void main(String[] args) throws Exception {
		System.exit(ToolRunner.run(new Configuration(), new RNGSearchDriver(), args));
	}
	...
	public int run(String[] args) throws Exception {
		...
		String l = model.encRangeWithoutNoise(left, true);
		String r = model.encRangeWithoutNoise(right, false);
		conf.set("m", modelStr);
		conf.set("l", l);
		conf.set("r", r);
		
		Job job = Job.getInstance(conf, "Search");
		job.setJarByClass(RNGSearchDriver.class);
		// TODO: specify a mapper
		job.setMapperClass(RNGSearchMapper.class);
